...
const Types = () => {
    ...
    return (
        <section className="relative px-4 overflow-hidden">
            ...
            <div className="container mx-auto px-1 items-center justify-between text-center relative mb-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
                    {categories.map((category) => (
                        <div
                            ...
                            className="backdrop-blur-md bg-white/40 border border-white/30 rounded-2xl px-5 py-2.5 shadow-sm hover:shadow-md transition-all duration-300 flex items-center gap-1 md:gap-5 cursor-pointer hover:scale-105 active:scale-95"
                        >
                            <img
                                src={category.icon}
                                alt={category.name}
