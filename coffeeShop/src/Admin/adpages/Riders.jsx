          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-gray-50 dark:bg-dark-bg text-gray-600 dark:text-dark-text uppercase text-xs tracking-wider">
              <tr>
                ...
                <th className="px-4 py-3 hidden xl:table-cell">Assigned</th>
                <th className="px-4 py-3 hidden xl:table-cell">Completed</th>
                <th className="px-4 py-3">Status</th>
                <th className="px-4 py-3 hidden sm:table-cell">Account</th>
              ...
              {currentRiders.length === 0 ? (
                ...
                currentRiders.map((rider) => (
                  <tr key={rider.id} className="hover:bg-gray-50 dark:hover:bg-dark-bg transition-colors">
                    ...
                    <td className="px-4 py-3 font-medium text-gray-800 dark:text-dark-heading">{rider.name}</td>
                    <td className="px-4 py-3 text-gray-600 dark:text-dark-text hidden md:table-cell">{rider.email}</td>
                    <td className="px-4 py-3 text-gray-600 dark:text-dark-text hidden lg:table-cell">{rider.phone}</td>
                    <td className="px-4 py-3 text-gray-600 dark:text-dark-text hidden xl:table-cell">{rider.assignedOrders}</td>
                    <td className="px-4 py-3 text-gray-600 dark:text-dark-text hidden xl:table-cell">{rider.completedDeliveries}</td>
                    <td className="px-4 py-3">
